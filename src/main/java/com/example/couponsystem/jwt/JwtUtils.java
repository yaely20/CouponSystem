...
public class JwtUtils implements Filter {
    ...
    public String generateToken(Credetional userDetails, ClientType clientType) {
    ...
    private boolean validateToken(String jwt) throws ServletException {
        ...
        try {
            ...
            newToken = generateToken(new Credetional(claims.getSubject(), null), ClientType.valueOf(claims.getIssuer()));
            removeToken(jwt);
        } catch (Exception e) {
            return false;
        }
